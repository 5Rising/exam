    ...
    <el-tab-pane name="first">
      ...
      <section class="append">
        <ul>
          ...
          <li v-if="optionValue == '代码题'">
            <span>所属章节：</span>
            <el-input
              placeholder="请输入对应章节"
              v-model="postCode.section"
              class="w150"
              clearable>
            </el-input>
          </li>
          ...
          <li v-if="optionValue == '代码题'">
            <span>难度等级:</span>
            <el-select v-model="postCode.level" placeholder="选择难度等级" class="w150">
              <el-option
                v-for="item in levels"
                :key="item.value"
                :label="item.label"
...
<!--        myself简答题-->
        <div class="change short" v-if="optionValue == '简答题'">
          <div class="title">
            <el-tag>题目:</el-tag><span>输入题目,形如--请你谈谈HTTP协议。</span>
            <el-input
              type="textarea"
              rows="4"
          ...
          <div class="title analysis">
            <el-tag>正确答案:</el-tag><span>下方输入框中输入答案解析</span>
            <el-input
              type="textarea"
              rows="4"
          ...
          <div class="submit">
            <el-button type="primary" @click="shortanswerSubmit()">立即添加</el-button>
          </div>
        </div>


<!--        代码题-->
        <div class="change code" v-if="optionValue == '代码题'">
          <div class="title">
            <el-tag>题目:</el-tag><span>请输入题目和代码</span>
            <el-input
              type="textarea"
              rows="8"
              v-model="postCode.question"
              placeholder="请输入代码内容"
              resize="none"
              class="answer">
            </el-input>
          ...
          <div class="title analysis">
            ...
            <el-input
              type="textarea"
              rows="8"
              v-model="postCode.answer"
              placeholder="请输入答案代码片段，包括分号"
              resize="none"
              class="answer">
            </el-input>
          </div>
          <div class="submit">
            <el-button type="primary" @click="codeSubmit()">立即添加</el-button>
          </div>
        </div>
      </section>
    </el-tab-pane>
...
export default {
  data() {
    return {
      ...
      postPaper: { //考试管理表对应字段
        paperId: null,
        questionType: null, // 试卷类型 1--选择题  2--填空题   3--判断题  4--简答题  5--代码题
        questionId: null,
      }
    };
  },
