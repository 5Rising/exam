  ...
  <div id="answer">
     <div class="flexarea">
        ...
        <div class="right">
          <div class="title">
            <p>{{title}}</p>
            <span><i class="iconfont icon-time"></i>倒计时：<b>{{this.hours+"hours"+this.minutes+"minutes"}}</b></span>
          </div>
          <div class="content">
          ...
          <div class="operation">
            <ul class="end">
              <li @click="previous()"><i class="iconfont icon-previous"></i></li>
              <li @click="saveData()"><i class="iconfont icon-mark-o"></i><span>保存</span></li>
              <li @click="next()"><i class="iconfont icon-next"></i></li>
            </ul>
          </div>
          <div class="code" v-if="currentType == 5">
            <router-view/>
