...
public class ExamManageServiceImpl implements ExamManageService {
    ...
    @Override
    public IPage<ExamManage> findAlls(Page<ExamManage> page) {
        return examManageMapper.findAlls(page);
    }
    ...
    @Override
    public IPage<ExamManage> findAllByInstitute(Page<ExamManage> page,String institute ) {
        return examManageMapper.findAllByInstitute(page,institute);
    }

    @Override
    public List<ExamManage> findAllByInstitute(String institute) {
        return examManageMapper.findAllByInstitute(institute);
    }
}
